...
func init() {
	...
	beego.Router("/api/idc", &controllers.IDCController{}, "post:AddOrUpdateIdc")                                //system
	...
	//beego.Router("/api/release/cancel", &controllers.ReleaseController{}, "get:CancelReleaseTask")               //ops dev qa
